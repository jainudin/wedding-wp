    ...
    $.extend(Timepicker.prototype, {
        ...
        _injectTimePicker:function() {
            ...
            if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
                var noDisplay = " ui_tpicker_unit_hide", html = '<div class="ui-timepicker-div' + (o.isRTL ? " ui-timepicker-rtl" :"") + (o.oneLine && o.controlType === "select" ? " ui-timepicker-oneLine" :"") + '"><dl>' + '<dt class="ui_tpicker_time_label"' + (o.showTime ? "" :noDisplay) + ">" + o.timeText + "</dt>" + '<dd class="ui_tpicker_time ' + (o.showTime ? "" :noDisplay) + '"></dd>';
