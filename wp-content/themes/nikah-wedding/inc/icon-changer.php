...
class nikah_wedding_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $nikah_wedding_Icon_Changer_array = nikah_wedding_Icon_Changer_array();
                    foreach ($nikah_wedding_Icon_Changer_array as $nikah_wedding_Icon_Changer) {
                            $icon_class = $this->value() == $nikah_wedding_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($nikah_wedding_Icon_Changer).'"></i>
                            <span class="nikah-wedding-social-class">'.esc_attr($nikah_wedding_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function nikah_wedding_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'nikah-wedding-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'nikah_wedding_icon_customize_js' );

if(!function_exists('nikah_wedding_Icon_Changer_array')){
    function nikah_wedding_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
